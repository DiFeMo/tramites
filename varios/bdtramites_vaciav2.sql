...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-07-2016 a las 05:07:13
...
--
-- Estructura de tabla para la tabla `tbentregado`
--

CREATE TABLE `tbentregado` (
  `identregado` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `documento` enum('Afiliacion Dependiente','Afiliacion Independiente','Afiliacion Domestica','SG - SST','Derecho Laboral','Creacion Empresa','Tramite General') NOT NULL,
...
CREATE TABLE `tbtramite` (
  ...
  `fecha` date NOT NULL,
  `tipotramite` enum('Afiliacion Dependiente','Afiliacion Independiente','SG - SST','Derecho Laboral','Creacion Empresa','Tramite general','Afiliacion Domestica') NOT NULL,
...
--
-- Indices de la tabla `tbentregado`
--
ALTER TABLE `tbentregado`
  ADD PRIMARY KEY (`identregado`);
...
--
-- AUTO_INCREMENT de la tabla `tbentregado`
--
ALTER TABLE `tbentregado`
  MODIFY `identregado` int(11) NOT NULL AUTO_INCREMENT;
--
