...
<?php include("controlador/cgastos.php"); ?>
	...
	<form action="index.php?pag=2&id=<?= $idgasto ?>" method="POST">
		...
		<div class="form-group col-md-6 col-lg-6">
            ...
            <input type="text" class="form-control" name="motivo" value="<?= $consultaedit[0]['motivo']  ?>" maxlength="100" placeholder="Motivo del gasto" required>
		</div>
		<div class="form-group col-md-6 col-lg-6">
			<label for=""><span style="color:red;">* </span>Valor:</label>
            <div class="input-group">
              <span class="input-group-addon">$</span>
              <input type="text" class="form-control" name="valor" value="<?= $consultaedit[0]['valor']  ?>" pattern="[0-9]{1,11}" min="0" title="Solo se permiten numeros, máximo 11" required readonly>
          	</div>
		</div>
		<div class="form-group col-md-6 col-lg-6">
